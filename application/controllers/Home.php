            ...
            for ($i = 0; $i < count($sections); $i++) {
                ...
                if (isset($theme[0]['name']) && strtolower($theme[0]['name']) == 'modern') {
                    ...
                    if ($sections[$i]['style'] == "cretzo_trending") {
                        ...
                        // fetch categories using the category ids defined in the section
                        $sections[$i]['categories_arr'] = $this->category_model->get_categories_by_ids($sections[$i]['categories']);
                    } else {
                        $limit = 12; // limiting to 10 just in case
                    }
                } else {
