            ...
            if (!$this->form_validation->run()) {
                ...
                if ($user_id) {
                    ...
                    $seller_data = array(
                        ...
                        'bank_name'                => $this->input->post('bank_name', true),   // FIXED: removed duplicate, kept true (XSS-safe)
                        'bank_code'                => $this->input->post('bank_code', true),
                        'account_name'             => $this->input->post('account_name', true),
                        'account_number'           => $this->input->post('account_number', true), // FIXED: removed duplicate, kept true (XSS-safe)
                        ...
                        'pan'                      => strtoupper((string)$this->input->post('pan', true)),
                        'gst'                      => strtoupper((string)$this->input->post('gst', true)),
                        'account_holder_name'      => $this->input->post('account_holder_name', true),
                        'ifsc'                     => strtoupper((string)$this->input->post('ifsc', true)),
