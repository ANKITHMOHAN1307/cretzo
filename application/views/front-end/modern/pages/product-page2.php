    ...
    <div class="container main-content mb-15 mt-10">
        ...
        <div class="d-flex flex-wrap">
            <div class="col-md-7">
                ...
                <div class="swiper-container swiper-thumbs-container product-gallery-thumbs" data-margin="10" data-dots="false" data-nav="true" data-thumbs="true">
                    <div class="d-flex product-preview-image-section-md">
                        <div class="col-md-2 overflow-auto product-thumb-img" style="height: 530px;">
                            <div class="swiper swiper-thumbs swiper-vertical">
                                        ...
                                        <div class="swiper-slide">
                                            <figure class="rounded">
                                                <?php if ($product['product'][0]['video_type'] == 'self_hosted') { ?>
                                                    <video controls width="320" height="240" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= $product['product'][0]['video'] ?>">
                                                ...
                                                <?php } else if ($product['product'][0]['video_type'] == 'youtube' || $product['product'][0]['video_type'] == 'vimeo') {
                                                    ...
                                                    <iframe width="560" height="315" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= $url ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                                <?php } ?>
                                            </figure>
                                        </div>
                                    <?php } ?>
                ...
                <div class="product-preview-image-section-sm overflow-hidden mb-9">
                                        ...
                                        <ul class="p-0">
                                            <li class="list-unstyled">
                                                <label class="btn text-center ">
                                                    <img class="swatche-image lazy" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= $swatche_values[$key] ?>">
    ...
    <div class="container mt-n6">
        <div class="row mt-4">
            ...
            <div class="tab-content p-3 w-100" id="nav-tabContent">
                <div class="tab-pane fade active show overflow-auto" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab">
...
<section class="wrapper bg-gray">
    <div class="container py-10 overflow-hidden">
        ...
        <div class="col-12 product-style-default pb-4 mt-2 mb-2 shop">
            ...
            <div class="swiper-container grid-view mb-6 mySwiper" data-margin="30" data-dots="true" data-items-xl="3" data-items-md="2" data-items-xs="1">
                ...
                <div <?= ($is_rtl == true) ? "dir='rtl'" : ""; ?> class="swiper-wrapper">
                    <?php foreach ($related_products['product'] as $row) { ?>
                        <div class="swiper-slide project item rounded">
                            <figure class="rounded">
