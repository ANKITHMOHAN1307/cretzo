                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide swiper-slide-category">
                        <a href="<?= base_url('home/categories/') ?>" class="text-decoration-none">
                            <img src="<?= base_url('uploads/media/new/dashboard.png') ?>" class="" alt="Explore all" />
            ...
            <div class="swiper-container category-swiper " data-dots="true">
                <div class="swiper-wrapper">
                    <?php foreach ($brands as $key => $row) { ?>
                        <div class="swiper-slide swiper-slide-category">
                            <a href="<?= base_url('products?brand=' . html_escape($row['slug'])) ?>" class="text-decoration-none">
                                <img class="lazy" src="<?= base_url('assets/front_end/modern/img/product-placeholder.jpg') ?>" data-src="<?= $row['image'] ?>" alt="<?= html_escape($row['name']) ?>"/>
                                <h6 class="fs-14 mb-0"><?= html_escape($row['name']) ?></h6>
                            </a>
                        </div>
            ...
            if ($row['style'] == 'default') {
                    ...
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <div class="offer-img">
                            <a href="<?= $offers[$count_key - 1]['link'] ?>">
                                <img class="img-fluid  my-4 rounded offer-image lazy" data-src="<?= base_url($offers[$count_key - 1]['image']) ?>" alt="Offer image" style="object-fit: cover;">
                            </a>
                        </div>
                <?php }
                } ?>
                ...
                <section class="wrapper mt-4">
                    <div class="my-4 featured-section-title">
                        <div class="d-md-flex justify-content-md-between">
                            <div>
                                <h3 class="text-dark mb-0"><?= ucfirst($row['title']) ?></h3>
                                        ...
                                        <div class="project item col-md-6 col-xl-3">
                                            ...
                                            <div class="post-header text-center mt-4">
                                                ...
                                                <p class="price text-dark">
                                                    <span class="amount"><?php $price = get_price_range_of_product($product_row['id']);
                                                                            echo $price['range'];
                                                                            ?></span>
                                                </p>
                                            </div>
                ...
                if ($count_key != 0) {
                    if (!empty($offers) && !empty($offers[$count_key - 1])) { ?>
                        <div class="offer-img">
                            <a href="<?= $offers[$count_key - 1]['link'] ?>">
                                <img class="img-fluid lazy my-4 rounded offer-image" data-src="<?= base_url($offers[$count_key - 1]['image']) ?>" alt="Offer image" style="object-fit: cover;">
                            </a>
                        </div>
                <?php }
                }
                                ...
                                <div class="mb-7 mt-4 text-center">
                                    ...
                                    <div class="product-content mt-2">
                                        ...
                                        <p class="text-dark m-0">
                                            <span class="amount"><?php $price = get_price_range_of_product($first_product['id']);
                                                                    echo $price['range'];
                                                                    ?></span>
                                        </p>
                                        <!-- <a href="#" class="add_to_cart  btn btn-sm btn-outline-primary rounded-pill mt-2"><i class="uil uil-shopping-bag"></i>&nbsp; Add to Cart</a> -->
                ...
                <section class="wrapper">
                    ...
                    <div class="row">
                        <div class="text-center mb-4">
                            <h3 class="display-4 mb-0"><?= ucfirst($row['title']) ?></h3>
                            <h2 class="fs-15 text-uppercase text-muted "><?= $row['short_description']; ?></h2>
