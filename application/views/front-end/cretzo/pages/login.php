            ...
            <div class="row">
                <div class="col-lg-8 content-center">
                    <div class="my-5">
                        ...
                        <div class="my-4">
                            <input type="text" class="form-control new-form" name="" placeholder="Phone Number/ Email ID" id="">
                        </div>
                        <div class="my-4">
                        ...
                        <div class="my-3 d-flex justify-content-between">
                            ...
                            <div class="">
                                <a href="#" class="active" style="font-size:small">Forget Password</a>
                            </div>
                        </div>
                        <div class="my-3">
                        ...
                        <div class="my-3 d-grid">
                            <button class="btnAddToCard"><a href="#" class="text-white aTag">Login</a></button>
                        </div>
                    </div>
                </div>
